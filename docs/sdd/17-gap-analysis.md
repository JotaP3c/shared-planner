...
| GAP-007 | Financeiro UI | resumo/períodos | backend completo; frontend incompleto | PARTIALLY_IMPLEMENTED | pronto | pendente | pronto | P1 |
| GAP-008 | Pagamentos | atualização coerente | backend + UI no detalhe | IMPLEMENTED | sim | sim | sim | — |
...
| GAP-015 | Rotas por papel | UX protegida | somente authGuard; backend protege | PARTIALLY_IMPLEMENTED | seguro | links/rotas inconsistentes | — | P1 |
...
| GAP-INFRA-002 | Paridade monorepo/standalone | backend 80/80 e frontend 74/74, zero divergências após exclusões normativas | nenhum gate técnico restante | VALIDATED | — |
